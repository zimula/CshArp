...
{
    internal class ServiceBookletPrinter:AbstractBookletPrinter
    {
        ...
        {
            Console.WriteLine("Printing front cover of Service booklet");
        }
        protected internal override void PrintTableOfContents()
        {
            Console.WriteLine("Print table of contents of Service booklet");
        }
        ...
        {
            Console.WriteLine("Printing index of Service booklet");
        }
        protected internal override void PrintBackCover()
        {
            Console.WriteLine("Print back cover of Service booklet");
        }
    }
}
